 ...
 */
package com.kesion.common.io;

import android.os.Build;
import com.kesion.common.io.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.kesion.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.kesion.common.io.stream.ByteArrayOutputStream output = new com.kesion.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link com.kesion.common.io.IOUtils#toByteArray(java.io.InputStream, int)} to read into the byte array.
     ...
     * @see com.kesion.common.io.IOUtils#toByteArray(java.io.InputStream, int)
     * @since 2.1
     */
