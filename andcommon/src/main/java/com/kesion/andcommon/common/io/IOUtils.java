 ...
 */
package com.kesion.andcommon.common.io;

import android.os.Build;
import com.kesion.andcommon.common.io.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.kesion.andcommon.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.kesion.andcommon.common.io.stream.ByteArrayOutputStream output = new com.kesion.andcommon.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
